...
public class GunItem extends WarmodModElements.ModElement {
	@ObjectHolder("warmod:gun")
	public static final Item block = null;
	@ObjectHolder("warmod:entitybulletgun")
	public static final EntityType arrow = null;
	public GunItem(WarmodModElements instance) {
		super(instance, 4);
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(WarmodItemGroup.tab).maxDamage(100));
			setRegistryName("gun");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 2, 5);
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("warmod:shotting")), SoundCategory.PLAYERS,
