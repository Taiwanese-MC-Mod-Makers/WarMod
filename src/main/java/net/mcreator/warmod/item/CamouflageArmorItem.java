...
public class CamouflageArmorItem extends WarmodModElements.ModElement {
	@ObjectHolder("warmod:camouflage_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("warmod:camouflage_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("warmod:camouflage_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("warmod:camouflage_armor_boots")
	public static final Item boots = null;
	public CamouflageArmorItem(WarmodModElements instance) {
		super(instance, 5);
	}
