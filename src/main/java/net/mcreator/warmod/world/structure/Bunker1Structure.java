...
package net.mcreator.warmod.world.structure;
...
public class Bunker1Structure extends WarmodModElements.ModElement {
	public Bunker1Structure(WarmodModElements instance) {
		super(instance, 13);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("warmod", "bunker-10x5x20"));
						if (template == null)
							return false;
