...
package net.mcreator.warmod.keybind;
...
public class ReloadGunKeyBinding extends WarmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public ReloadGunKeyBinding(WarmodModElements instance) {
		super(instance, 12);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.reload_gun", GLFW.GLFW_KEY_R, "key.categories.warmod");
